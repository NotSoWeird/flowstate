...
with lib;
with lib.flowstate;
let cfg = config.flowstate.desktop.hyprland.addons.waybar;
in {
  options.flowstate.desktop.hyprland.addons.waybar = with types; {
    enable = mkBoolOpt false "Enable or disable Waybar";
  };

  config = mkIf cfg.enable {
    flowstate.home.extraOptions.programs.waybar = {
      enable = true;
      ...
      style = ''
        * {
            ...
            font-family: FontAwesome, ${lib.flowstate.setting.font};
              font-size: 20px;
            }
