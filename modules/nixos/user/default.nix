...
in
{
    options.user = with types; {
        ...
        fullName = mkOpt str "Wiktor Liew" "The full name of the user.";
        email = mkOpt str "wiktor@liew.se" "The email of the user.";
        initialHashedPassword = mkOpt str "$y$j9T$E4XvWYZnoG8B3iq.bP7fa.$9k9d/SWNcCBi9lA6uGkMVoYT2XrO0mYymgYZ09rwa46" "The hashed password to use when the user is first created.";
